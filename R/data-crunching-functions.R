...
#' Function calculating windowed hrvhra results
#' @param RR rr object
...
#' @export
get_pp_windowed_results <- function(RR,
...
#' Function calculating windowed runs results
#' @param RR rr object
#' @param window_type type of window, can be time or index
#' @param slide_type how should the window move: slide or jump
#' @param window_length length of the window, in minutes or beats, according to window_type
#' @retur data.frame with results for windows as rows
#' @export
get_runs_windowed_results <- function(RR,
                                      time_functions_list = glb_time_functions,
                                      window_type = "time",
                                      move_type = "jump",
                                      window_length = 5,
...
#' Function calculating windowed quality results
#' @param RR rr object
#' @param window_type type of window, can be time or index
#' @param slide_type how should the window move: slide or jump
#' @param window_length length of the window, in minutes or beats, according to window_type
#' @retur data.frame with results for windows as rows
#' @export
get_quality_windowed_results <- function(RR,
                                         time_functions_list = glb_time_functions,
                                         window_type = "time",
                                         move_type = "jump",
                                         window_length = 5,
...
#' Function calculating windowed spectral results
#' @param RR rr object
#' @param window_type type of window, can be time or index
#' @param slide_type how should the window move: slide or jump
#' @param window_length length of the window, in minutes or beats, according to window_type
#' @retur data.frame with results for windows as rows
#' @export
get_spectral_windowed_results <- function(RR,
                                         time_functions_list = glb_time_functions,
                                         window_type = "time",
                                         move_type = "jump",
                                         window_length = 5,
